...
class SpriteKind:
    ...
    npcone = SpriteKind.create()
    BOSSS = SpriteKind.create()
    REVEAL = SpriteKind.create()

def on_on_overlap(sprite, otherSprite):
    game.game_over(False)
sprites.on_overlap(SpriteKind.BOSSS, SpriteKind.player, on_on_overlap)

def on_on_score():
    game.show_long_text("lEVEL 4! ", DialogLayout.BOTTOM)
    game.show_long_text("WE used cans for the shell of our car", DialogLayout.BOTTOM)
    mySprite2.follow(mySprite, 42)
info.on_score(14, on_on_score)

def on_on_score2():
    global mySprite4, mySprite5
    game.show_long_text("BOSS", DialogLayout.BOTTOM)
    game.show_long_text("\"MY REVENGE!\"", DialogLayout.BOTTOM)
    ...
    mySprite5 = sprites.create(img("""
            ...
            """),
        SpriteKind.REVEAL)
    animation.run_image_animation(mySprite5,
        [img("""
                . . . . . . . . . . . . . . . .
                . . . . . . . . . . . . . . . .
                . . . . . . . . . . . . . . . .
...
def on_on_overlap3(sprite3, otherSprite3):
    ...
    mySprite3.set_position(randint(3, 120), randint(3, 120))
sprites.on_overlap(SpriteKind.player, SpriteKind.food, on_on_overlap3)

def on_on_score3():
    game.show_long_text("LEVEL 5!", DialogLayout.BOTTOM)
    game.show_long_text("our vice-captain Harper", DialogLayout.BOTTOM)
    mySprite2.follow(mySprite, 52)
info.on_score(20, on_on_score3)

def on_on_score4():
    game.show_long_text("lEVEL 2! ", DialogLayout.BOTTOM)
    game.show_long_text("We decided for a turtle logo to show awareness",
        DialogLayout.BOTTOM)
    mySprite2.follow(mySprite, 21)
info.on_score(5, on_on_score4)

def on_on_score5():
    global Charlie
    game.show_long_text("lEVEL 3! ", DialogLayout.BOTTOM)
    game.show_long_text("Captain: Charlie", DialogLayout.BOTTOM)
    Charlie = sprites.create(assets.image("""
        Harper
        """), SpriteKind.npcone)
    sprites.destroy(Charlie, effects.cool_radial, 2000)
    mySprite2.follow(mySprite, 35)
info.on_score(8, on_on_score5)
...
mySprite3 = sprites.create(img("""
        ...
        """),
    SpriteKind.food)
scaling.scale_by_percent(mySprite, -10, ScaleDirection.UNIFORMLY, ScaleAnchor.MIDDLE)
...
scene.set_background_image(img("""
    ...
    bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb
    """))
mySprite2.set_position(6, 5)
info.set_score(0)
game.show_long_text("We raised £257 at our bakesale :)", DialogLayout.BOTTOM)
